    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form action="{{route('admin.sliders.update',$slider->id)}}" method="POST"
                    ...
                    <div class="form-group form-float">
                        ...
                        <textarea name="title" id="tinymce">{{$slider->title}}</textarea>
                        {{-- <div class="form-line">
            ...
            <div class="form-group">
                <img src="{{Storage::disk('public')->url('slider/'.$slider->image)}}" id="slider-imgsrc-edit"
                    alt="{{$slider->title}}" class="img-responsive img-rounded">
            </div>
            @endif
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="tinymce-description">{{$slider->description}}</textarea>
                {{-- <div class="form-line">
                    <textarea name="description" rows="4"
                        class="form-control no-resize">{{$slider->description}}</textarea>
            </div> --}}
        </div>
