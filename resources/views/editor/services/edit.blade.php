            ...
            <div class="body">
                <form action="{{route('admin.services.update',$service->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <textarea name="description" rows="4"
                                class="form-control no-resize">{{ $service->description }}</textarea>
                    ...
                    <div class="form-group form-float">
                        ...
                        <small>To get icons name list just click the link: <a
                                href="https://materializecss.com/icons.html" target="_blank">Materialize
                                Icon</a></small>
                    </div>
