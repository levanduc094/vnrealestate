...
<div class="row clearfix">
    ...
    <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
        ...
        <div class="card">
            ...
            <div class="body">
                <img class="img-responsive" src="{{Storage::disk('public')->url('property/'.$property->floor_plan)}}"
                    alt="{{$property->title}}">
            </div>
            @endif
        </div>
        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <img class="img-responsive thumbnail"
                    src="{{Storage::disk('public')->url('property/'.$property->image)}}" alt="{{$property->title}}">
