                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img src="{{Storage::disk('public')->url('posts/'.$post->image)}}"
                                        alt="{{$post->title}}" class="img-responsive img-rounded">
                                    @endif
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    @else
                                    <span class="badge bg-pink">False</span>
                                    @endif
                                </td>
                                ...
                                <td class="text-center">
                                    <a href="{{route('editor.posts.show',$post->slug)}}"
                                        class="btn btn-success btn-sm waves-effect">
                                        <i class="material-icons">visibility</i>
                                    </a>
                                    {{-- @if($post->status != 1) --}}
                                    <a href="{{route('editor.posts.edit',$post->slug)}}"
                                    ...
                                    <form action="{{route('editor.posts.destroy',$post->slug)}}" method="POST"
