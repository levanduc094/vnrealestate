                            ...
                            <div class="row">
                                ...
                                <div class="file-field input-field col s2">
                                    @if(Storage::disk('public')->exists('property/'.$property->image) && $property->image )
                                        <img src="{{Storage::disk('public')->url('property/'.$property->image)}}" alt="{{$property->title}}" class="responsive-img">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="file-field input-field col s2">
                                    @if(Storage::disk('public')->exists('property/'.$property->floor_plan) && $property->floor_plan )
                                        <img src="{{Storage::disk('public')->url('property/'.$property->floor_plan)}}" alt="{{$property->title}}" class="responsive-img">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row m-b-0">
                                ...
                                <div class="col m3 s6">
                                    <div class="gallery-image-edit" id="gallery-{{$gallery->id}}">
                                        ...
                                        <img class="responsive-img" src="{{Storage::disk('public')->url('property/gallery/'.$gallery->name)}}" alt="{{$gallery->name}}">
                                    </div>
                                </div>
                                @endforeach
                            </div>
