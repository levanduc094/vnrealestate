...
<div class="row">
    <div class="col s12 m6 offset-m3">
        <div class="card">
            ...
            <h4 class="center indigo-text uppercase p-t-30">{{ __('default.login') }}</h4>
            ...
            <div class="p-20">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <label for="password">{{ __('default.password') }}</label>
                    ...
                    <p>
                        <label>
                            ...
                            <span>{{ __('message.rememberMe') }}</span>
                        </label>
                    </p>
