...
<head>
    ...
    <link href="https://cdn.bootcss.com/toastr.js/latest/css/toastr.min.css" rel="stylesheet" type="text/css">
...
<body class="theme-indigo">
    ...
    {{-- MAIN NAVIGATION BAR --}}
    @include('backend.editor.partials.navbar')

    {{-- SIDEBAR LEFT --}}
    <section>
        @include('backend.editor.partials.sidebar')
    </section>
