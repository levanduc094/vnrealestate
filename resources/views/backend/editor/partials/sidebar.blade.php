    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="{{ Request::is('editor/posts*') ? 'active' : '' }}">
                ...
                {{-- <ul class="ml-menu">
                    <li class="{{ Request::is('editor/posts/users') ? 'active' : '' }}">
                <a href="{{ route('editor.posts.postFromUsers') }}">
                    <span>Posts from users</span>
                </a>
            </li>
            <li class="{{ Request::is('editor/posts/editors') ? 'active' : '' }}">
                <a href="{{ route('editor.posts.index') }}">
                    <span>Posts</span>
                </a>
            </li>
        ...
        <li class="{{ Request::is('editor/settings*') ? 'active' : '' }}">
            ...
            <ul class="ml-menu">
                ...
                <li class="{{ Request::is('editor/profile') ? 'active' : '' }}">
