                ...
                <div class="col s12 m8">
                    ...
                    <div class="card horizontal card-no-shadow m-b-60">
                        <div class="card-image agent-image">
                            <img src="{{Storage::disk('public')->url('users/'.$agent->image)}}" alt="{{ $agent->username }}" class="imgresponsive">
                        </div>
                    ...
                    @foreach($properties as $property)
                        ...
                        <div class="card horizontal card-no-shadow border1">
                            <div class="card-image horizontal-bg-image">
                                <span class="card-image-bg" style="background-image:url({{Storage::disk('public')->url('property/'.$property->image)}});"></span>
                            </div>
