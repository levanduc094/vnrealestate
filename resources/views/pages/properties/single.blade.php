        ...
        <div class="row">
            <div class="col s12 m8">
                ...
                <div>
                    ...
                    @endif
                    <span class="btn btn-small disabled b-r-20">{{ __('views.default.area') }}: {{ $property->area}}
            ...
            <div class="col s12 m4">
                <div>
                    ...
                    <button type="button" class="btn btn-small m-t-25 right disabled b-r-20">
                        {{__('default.for'.ucfirst($property->purpose))}}
                    </button>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col s12 m8">
                ...
                <div class="single-image">
                    ...
                    <img src="{{Storage::disk('public')->url('property/'.$property->image)}}" alt="{{$property->title}}"
                        class="imgresponsive">
                    @endif
                </div>
                @endif
                ...
                <div>
                    @if($property->features and count($property->features) > 0)
                    <ul class="collection with-header">
                        <li class="collection-header grey lighten-4">
                            <h5 class="m-0">{{__('default.features')}}</h5>
                        </li>
                ...
                <div class="card-no-box-shadow card">
                    <div class="p-15 grey lighten-4">
                        <h5 class="m-0">{{__('default.floorPlan')}}</h5>
                    </div>
                    <div class="card-image">
                        @if(Storage::disk('public')->exists('property/'.$property->floor_plan) && $property->floor_plan)
                        <img src="{{Storage::disk('public')->url('property/'.$property->floor_plan)}}"
                            alt="{{$property->title}}" class="imgresponsive">
                        @endif
                    </div>
                </div>

                @if(isset($property->location_longitude) && isset($property->location_latitude))
                <div class="card-no-box-shadow card">
                    <div class="p-15 grey lighten-4">
                        <h5 class="m-0">{{__('default.location')}}</h5>
                    </div>
                    <div class="card-image">
                        <!-- <div id="map"></div> -->
                        <div id="mapid"></div>
                ...
                <div class="card-no-box-shadow card">
                    <div class="p-15 grey lighten-4">
                        <h5 class="m-0">{{__('default.nearBy')}}</h5>
                    </div>
                ...
                <div class="card-no-box-shadow card">
                    <div class="p-15 grey lighten-4">
                        <h5 class="m-0">
                            {{ $property->approved_comments_count }} {{__('default.comments')}}
                            @auth
                    ...
                    <div class="single-narebay p-15">
                        ...
                        <div class="comment children">
                            <div class="author-image">
                                <span
                                    style="background-image:url({{ Storage::disk('public')->url('users/'.$commentchildren->users->image) }});"></span>
                            </div>
                            <div class="content">
                                <div class="author-name">
            ...
            <div class="col s12 m4">
                <div class="clearfix">
                    ...
                    <div>
                        <ul class="collection with-header">
                            <li class="collection-header grey lighten-4">
                                <h5 class="m-0">{{__('default.cityList')}}</h5>
                            </li>
                    ...
                    @if($relatedproperty and count($relatedproperty) > 0)
                    <div>
                        <ul class="collection with-header">
                            <li class="collection-header grey lighten-4">
                                <h5 class="m-0">{{__('default.relatedProperties')}}</h5>
                            </li>
                            ...
                            <li class="collection-item p-0">
                                <a href="{{ route('property.show',$property_related->id) }}">
                                    <div class="card horizontal card-no-shadow m-0">
                                        ...
                                        <div class="card-image">
                                            <img src="{{Storage::disk('public')->url('property/'.$property_related->image)}}"
                                        ...
                                        <div class="card-stacked">
                                            <div class="p-l-10 p-r-10 indigo-text">
                                                <h6 title="{{$property_related->title}}">
                                                    {{ str_limit( $property_related->title, 18 ) }}</h6>
...
<script type="text/javascript">
    var map = new ol.Map({
        ...
        view: new ol.View({
          center: ol.proj.fromLonLat([<?php echo $property->location_longitude;?>, <?php echo $property->location_latitude;?>]),
          zoom: 15
        })
      });
</script>
