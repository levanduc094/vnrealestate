<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">{{ __('views.news.popularNews') }}</h3>
        <ul class="collection">
...
<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">{{ __('views.news.categories') }}</h3>
        <ul>
            @foreach($categories as $category)
            <li class="category-bg-image"
                style="background-image:url({{Storage::disk('public')->url('category/slider/'.$category->image)}});">
...
<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">{{ __('views.news.tags') }}</h3>
