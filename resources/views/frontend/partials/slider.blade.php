<section class="carousel carousel-slider center" data-interval="1000">
    @if($sliders)
    @foreach($sliders as $slider)
    <div class="carousel-item"
        style="background-image: url({{Storage::disk('public')->url('slider/'.$slider->image)}}); background-position: top; background-size: cover;"
        href="#{{$slider->id}}!">
