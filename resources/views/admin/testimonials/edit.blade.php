                ...
                <form action="{{route('admin.testimonials.update',$testimonial->id)}}" method="POST"
                    ...
                    <div class="form-group">
                        <img src="{{Storage::disk('public')->url('testimonial/'.$testimonial->image)}}"
                            id="testimonial-imgsrc-edit" alt="{{$testimonial->title}}"
                            class="img-responsive img-rounded">
                    </div>
                    @endif
                    <div class="form-group">
                        <input type="file" name="image" id="testimonial-image-input-edit" style="display:none;">
                        <button type="button" class="btn bg-grey btn-sm waves-effect m-t-15"
                            id="testimonial-image-btn-edit">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <textarea name="testimonial" rows="4"
                                class="form-control no-resize">{{$testimonial->testimonial}}</textarea>
                        </div>
                    </div>
