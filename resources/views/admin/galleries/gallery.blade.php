    ...
    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-indigo">
                <h2>
                    GALLERY IMAGE
                    <a href="{{ route('admin.album') }}" class="right" title="Back"><i
            ...
            <div class="body">
                <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <a href="{{Storage::disk('public')->url('gallery/'.$gallery->image)}}"
                            data-sub-html="Demo Description">
                            <img class="img-responsive thumbnail"
                                src="{{Storage::disk('public')->url('gallery/'.$gallery->image)}}">
                        </a>
                    </div>
                    @endforeach
                </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <a href="{{route('admin.album.gallery',$album_id)}}" class="btn btn-indigo btn-lg m-t-15 waves-effect"
                    style="width:100%">
