...
Route::post('/blog/message', 'PagesController@messageAuthor')->name('blog.message');
...
Route::group(['prefix'=>'user','namespace'=>'User','middleware'=>['auth','user'],'as'=>'user.'], function(){
    ...
    Route::get('posts/create','DashboardController@postsCreate')->name('posts.create');
    Route::get('posts/show/{id}','DashboardController@postsShow')->name('posts.show');
    Route::get('posts/edit/{id}','DashboardController@postsEdit')->name('posts.edit');
    Route::post('posts/store','DashboardController@postsStore')->name('posts.store');
    Route::post('posts/update/{id}','DashboardController@postsUpdate')->name('posts.update');
...
Route::group(['prefix'=>'editor','namespace'=>'Editor','middleware'=>['auth','editor'],'as'=>'editor.'], function(){
